...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1750, 862)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.frame = QtWidgets.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(10, 20, 851, 621))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.openVideo = QtWidgets.QPushButton(self.frame)
        self.openVideo.setGeometry(QtCore.QRect(60, 550, 129, 32))
        self.openVideo.setObjectName("openVideo")
        self.continuePlay = QtWidgets.QPushButton(self.frame)
        self.continuePlay.setGeometry(QtCore.QRect(330, 550, 129, 32))
        self.continuePlay.setObjectName("continuePlay")

        self.label = QtWidgets.QLabel(self.frame)
        self.label.setGeometry(QtCore.QRect(20, 20, 801, 511))
        self.label.setObjectName("label")
        self.frame_2 = QtWidgets.QFrame(self.centralwidget)
        self.frame_2.setGeometry(QtCore.QRect(10, 660, 851, 111))
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.startTrack = QtWidgets.QPushButton(self.frame_2)
        self.startTrack.setGeometry(QtCore.QRect(40, 30, 129, 32))
        self.startTrack.setObjectName("startTrack")
        self.frame_3 = QtWidgets.QFrame(self.centralwidget)
        self.frame_3.setGeometry(QtCore.QRect(880, 20, 851, 621))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.continuePlayVis = QtWidgets.QPushButton(self.frame_3)
        self.continuePlayVis.setGeometry(QtCore.QRect(370, 550, 129, 32))
        self.continuePlayVis.setObjectName("continuePlayVis")
        self.stopPlayVis = QtWidgets.QPushButton(self.frame_3)
        self.stopPlayVis.setGeometry(QtCore.QRect(620, 550, 129, 32))
        self.stopPlayVis.setObjectName("stopPlayVis")
        self.label_2 = QtWidgets.QLabel(self.frame_3)
        self.label_2.setGeometry(QtCore.QRect(23, 23, 801, 511))
        self.label_2.setObjectName("label_2")
        self.visResult = QtWidgets.QPushButton(self.frame_3)
        self.visResult.setGeometry(QtCore.QRect(110, 550, 129, 32))
        self.visResult.setObjectName("visResult")
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(883, 654, 841, 121))
        self.textEdit.setObjectName("textEdit")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1750, 32))
        ...
        self.flag = 0
        self.flag_1 = 0
        self.openVideo.clicked.connect(self.selectVideo)
        self.continuePlay.clicked.connect(self.slotStartOrstop)
        self.continuePlayVis.clicked.connect(self.slotStartOrstop_1)
        self.videoName = None
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.continuePlay.setText(_translate("MainWindow", "播放"))
        # self.label.setText(_translate("MainWindow", "TextLabel"))
        self.startTrack.setText(_translate("MainWindow", "开始跟踪"))
        self.continuePlayVis.setText(_translate("MainWindow", "播放"))
        # self.label_2.setText(_translate("MainWindow", "TextLabel"))
        self.visResult.setText(_translate("MainWindow", "可视化结果"))
    def selectVideo(self):
        ...
        file_path, filetype = QFileDialog.getOpenFileName(None,
                                                          "选取文件",
                                                          "./",
                                                          "视频文件(*.mp4 *.avi)")  # 设置文件扩展名过滤,注意用双分号间隔
        self.videoName = file_path
        self.outputWritten("视频路径：" + file_path + "\n")
        self.file_path = file_path
        self.cap = cv2.VideoCapture(self.file_path)
        self.timer_camera = QTimer()
        self.flag = 0
        self.openFrame()
    def slotStartOrstop(self):
        ...
        if self.flag == 0:
            ...
            self.continuePlay.setText("暂停")
        elif self.flag == 1:
            self.timer_camera.stop()
            self.flag = 2
            self.continuePlay.setText("播放")
    ...
    def slotStartOrstop_1(self):

        if self.flag_1 == 1:
            self.timer_camera_1.start(100)
            self.flag_1 = 1

            self.continuePlayVis.setText("暂停")

        else:
            self.timer_camera_1.stop()
            self.flag_1 = 2
            self.continuePlayVis.setText("播放")
    def openFrame(self):
    ...
    def openFrame_1(self):
        ...
        if(self.cap_1.isOpened()):
            ...
            if ret:
                ...
                self.cap_1.release()
                self.timer_camera_1.stop()   # 停止计时器
    def tracking(self):
        self.cap_2 = cv2.VideoCapture(self.videoName)
        count = 0
        while True:
    ...
    def tracking(self):
        ...
        while True:
            ...
            if ret:
                timer.tic()
                if count % 20 == 0:
                    print('Processing frame {}/{} ({:.2f} fps)'.format(videoName, count,
                ...
                with torch.no_grad():
                    ...
                    if count > 0:
                        ...
                        if len(dets) > 0:  # det都初始成track
                            '''Detections'''
                            detections = [
                                STrack(STrack.tlbr_to_tlwh(tlbrs[:4]), STrack.tlbr_to_tlwh(tlbrs[5:9]), tlbrs[4], f,
                                       vis_f,
                                       30)
                                for
