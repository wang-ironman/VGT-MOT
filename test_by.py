        ...
        with torch.no_grad():
            ...
            if idx > 0:
                ...
                if (idx - 1) == 0:
                    ...
                    if not os.path.exists(os.path.join(model_dir, 'result', cur_dataset)):
                        os.mkdir(os.path.join(model_dir, 'result', cur_dataset))
                    # print(os.path.join(model_dir, 'result', cur_dataset, '{:05d}.jpg'.format(idx)))
                    # print(online_im.shape)
                    cv2.imwrite(os.path.join(model_dir, 'result', cur_dataset, '{:05d}.jpg'.format(idx)),
                                online_im)
                ...
                # print(os.path.join(model_dir, 'result', cur_dataset, '{:05d}.jpg'.format(idx)))
                # print(online_im.shape)
                cv2.imwrite(os.path.join(model_dir, 'result', cur_dataset, '{:05d}.jpg'.format(idx)), online_im)
                videoWriter.write(online_im)
                ...
                if not os.path.exists(os.path.join(model_dir, 'result_line', cur_dataset + "_line")):
                    os.mkdir(os.path.join(model_dir, 'result_line', cur_dataset + "_line"))

                cv2.imwrite(
                    os.path.join(model_dir, 'result_line', cur_dataset + "_line") + "/" + str(idx) + ".jpg",
                    img)
